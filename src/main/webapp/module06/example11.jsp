...
<jsp:include page="/utils/header.jsp">
	<jsp:param name="title" value="Module 06, Example 11" />
	<jsp:param name="page" value="/module06/example11.jsp" />
</jsp:include>
		...
		<div class="col-sm-6">
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<form role="form" action="/JEECourse/module06/example11a.jsp">
